...
func autogenDisclaimer*(): string =
  "# Generated by nimrodot on " & CompileDate & "T" & CompileTime & "Z\n" &
...
proc renderImportList*(
  ...
  let relativeRootPath = "nimrodot".relativePath(selfDir) & "/"
  let classesPath = "nimrodot/classes/types".relativePath(selfDir) & "/"
  let builtinsPath = "nimrodot/builtins/types".relativePath(selfDir) & "/"
